...
public class Main{
    public static void main(String[] args){
        ...
        AlertService alertService = new ThresholdAlertService(10000.0, 20); //Creo la instancia de la estrategia AlertService llamada alertService
        ILogger logger = Logger.getInstance(); //Creo la instancia del logger (primera letra con minuscula) llamada logger
        ...
        AlertObserver alerta = new AlertObserver(alertService, logger);
